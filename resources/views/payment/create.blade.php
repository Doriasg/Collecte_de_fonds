        ...
        <form action="{{ route('payment.process') }}" method="POST" class="form">
            ...
            <div class="row">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-500 text-xs mt-1">Format: +2290194119476</p>
                </div>
                 ...
                 <div class="mb-4">
                    ...
                    <div class="flex">
                        <input type="email" name="email" class="w-full px-3 py-2 border border-gray-300 rounded-r focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                    </div>
                </div>
